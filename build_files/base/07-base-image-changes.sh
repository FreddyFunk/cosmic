...
ln -sf /usr/share/wallpapers/vivid-wallpaper-1/contents/images/15392x8616.jpg /usr/share/backgrounds/default.png
ln -sf /usr/share/wallpapers/vivid-wallpaper-1/contents/images/15392x8616.jpg /usr/share/backgrounds/default-dark.png
ln -sf vivid.xml /usr/share/backgrounds/default.xml
...
# Test vivid gschema override for errors. If there are no errors, proceed with compiling vivid gschema, which includes setting overrides.
mkdir -p /tmp/vivid-schema-test
find /usr/share/glib-2.0/schemas/ -type f ! -name "*.gschema.override" -exec cp {} /tmp/vivid-schema-test/ \;
cp /usr/share/glib-2.0/schemas/zz0-vivid-modifications.gschema.override /tmp/vivid-schema-test/
echo "Running error test for vivid gschema override. Aborting if failed."
glib-compile-schemas --strict /tmp/vivid-schema-test
echo "Compiling gschema to include vivid setting overrides"
