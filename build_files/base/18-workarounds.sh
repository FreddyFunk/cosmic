...
# Current vivid systems have the bling.sh and bling.fish in their default locations
mkdir -p /usr/share/ublue-os/vivid-cli
cp /usr/share/ublue-os/bling/* /usr/share/ublue-os/vivid-cli
